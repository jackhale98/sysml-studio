...
const KIND_FILTER_ITEMS: SearchSelectItem[] = [
  // Structure
  { id: "PartDefinition", label: "Part Definition", badge: "structure", badgeColor: "#3b82f6", group: "Structure" },
  { id: "PartUsage", label: "Part (Def + Usage)", badge: "structure", badgeColor: "#3b82f6", group: "Structure" },
  { id: "PortDefinition", label: "Port Definition", badge: "structure", badgeColor: "#8b5cf6", group: "Structure" },
  { id: "PortUsage", label: "Port (Def + Usage)", badge: "structure", badgeColor: "#8b5cf6", group: "Structure" },
  { id: "AttributeDefinition", label: "Attribute Definition", badge: "structure", badgeColor: "#f59e0b", group: "Structure" },
  { id: "AttributeUsage", label: "Attribute (Def + Usage)", badge: "structure", badgeColor: "#f59e0b", group: "Structure" },
  { id: "ItemDefinition", label: "Item Definition", badge: "structure", badgeColor: "#6366f1", group: "Structure" },
  { id: "ItemUsage", label: "Item (Def + Usage)", badge: "structure", badgeColor: "#6366f1", group: "Structure" },
  { id: "EnumerationDefinition", label: "Enumeration", badge: "structure", badgeColor: "#10b981", group: "Structure" },
  // Behavior
  { id: "ActionDefinition", label: "Action Definition", badge: "behavior", badgeColor: "#c084fc", group: "Behavior" },
  { id: "ActionUsage", label: "Action (Def + Usage)", badge: "behavior", badgeColor: "#c084fc", group: "Behavior" },
  { id: "StateDefinition", label: "State Definition", badge: "behavior", badgeColor: "#c084fc", group: "Behavior" },
  { id: "StateUsage", label: "State (Def + Usage)", badge: "behavior", badgeColor: "#c084fc", group: "Behavior" },
  { id: "CalculationDefinition", label: "Calculation", badge: "behavior", badgeColor: "#f97316", group: "Behavior" },
  { id: "FlowUsage", label: "Flow", badge: "behavior", badgeColor: "#c084fc", group: "Behavior" },
  // Requirement
  { id: "RequirementDefinition", label: "Requirement Definition", badge: "requirement", badgeColor: "#ef4444", group: "Requirement" },
