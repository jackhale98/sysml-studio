...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::risk_commands::list_fmea_items,
            commands::risk_commands::fmea_risk_matrix,
            commands::risk_commands::list_tolerance_dimensions,
            commands::risk_commands::compute_stackup,
            commands::risk_commands::list_data_rows,
            commands::risk_commands::list_calcs,
            commands::risk_commands::run_calc_over_rows,
